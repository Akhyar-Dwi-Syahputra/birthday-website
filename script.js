document.addEventListener("DOMContentLoaded", () => {
      ...
      let currentRecipient = "ayy akuh yang paling tercinta";

      const vibesMessages = {
        sweet: [
          "Selamat ulang tahun ya ayy akuh! Di hari istimewa ini, aku bersyukur sekali kamu ada di dunia ini ayy akuh. Makasih karena selalu bawa kehangatan serta perhatiannya ya ayy akuh. Semoga seluruh impian manismu terwujud, tetap jadi diri sendiri yang luar biasa, sehat selalu ya ayy akuh!",
          "Happy Birthday! Semoga langkahmu ke depan selalu dituntun oleh kemudahan dan kebahagiaan sejati. Aku bangga banget punya kamu dalam hidupku ayy akuh."
        ],
        gokil: [
          "Selamat ulang tahun yah ayy akuh! Ciee yang usianya makin berkurang tapi tingkahnya masih seperti balita yang manja, tapi sukaa.... jangan berenti maja sama aku yah ayy akuh. Semoga sehat selalu biar bisa terus bareng-bareng yeyy!"
        ],
        deep: [
          "Seiring bertambahnya angka usiamu hari ini, aku merenungi betapa berartinya kehadiranmu di sini ayy akuh. Hidup mungkin tidak selalu mudah, tapi jiwamu yang tangguh selalu sanggup melewati segalanya. Selamat ulang tahun. Terima kasih atas ketulusanmu ayy akuh, semoga kedamaian sejati selalu memelukmu ayy akuh.",
          "Hari ini adalah pengingat berharga betapa istimewanya kamu ayy akuh. Semoga setiap impian tersembunyi di relung hatimu segera menemukan jalan indahnya untuk mekar."
        ]
      };
      ...
      if (surpriseBtn) {
        surpriseBtn.addEventListener("click", () => {
          if (recipientInput) {
            ...
            currentRecipient = val !== "" ? val : "ayy akuh tercinta";
          }
      ...
      const birthdayWishes = [
        "Semoga tahun ini membawakanmu rezeki yang mlimpah, kesehatan tanpa batas, dan senyuman termanis.",
        "Setiap hari bersamamu adalah kado luar biasa. Selamat ulang tahun ayy akuh!",
        ...
        "Terima kasih telah membawakan tawa riang untuk setiap sudut hari-hari kita ayy akuh. Selamat ulang tahun!"
      ];
